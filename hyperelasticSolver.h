...
namespace
{
  ...
  public:
    Time(const double time_end, const double delta_t) :
      timestep(0), current(0.0), end(time_end),
      delta(delta_t) {}
    virtual ~Time() {}
...
namespace IFEM
{
  ...
  private:
     ...
     */
    Errors errorResidual, errorResidual0, errorResidualNorm,
           errorUpdate, errorUpdate0, errorUpdateNorm;
