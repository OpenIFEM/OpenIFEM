...
int main(int argc, char *argv[])
{
  ...
  if (params.dimension == 3)
  {
    ...
    parallel::distributed::Triangulation<3> eul_tria(PETSC_COMM_WORLD);
    ...
    Solid::MPI::SharedLinearElasticity<3> solid(lag_tria, params);
    // Create FSI object
    MPI::OpenIFEM_Sable_FSI<3> fsi(fluid, solid, params, false);
    fsi.run();
  }
else
  {
