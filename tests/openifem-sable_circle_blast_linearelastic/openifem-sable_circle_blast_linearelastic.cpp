  ...
  if (params.dimension == 2)
    {
      ...
      // Read mesh file for the circle
      GridIn<2> grid_in_1;
      Triangulation<2> circle_tria_1;
      std::ifstream input_solid_1("circle.inp");
      grid_in_1.attach_triangulation(circle_tria_1);
      grid_in_1.read_abaqus(input_solid_1);

      GridIn<2> grid_in_2;
      Triangulation<2> circle_tria_2;
      std::ifstream input_solid_2("circle.inp");
      grid_in_2.attach_triangulation(circle_tria_2);
      grid_in_2.read_abaqus(input_solid_2);

      GridIn<2> grid_in_3;
      Triangulation<2> circle_tria_3;
      std::ifstream input_solid_3("circle.inp");
